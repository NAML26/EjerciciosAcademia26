...
public class BankAccount {
    ...
    public void deposit(double amount) {
        ...
        if (amount <= 0)
            throw new InvalidAmountException("Monto inválido" + amount);
    ...
    public void withdraw(double amount) throws InsufficientBalanceException {
        ...
        public void transfer (BankAccount target,double amount)
            ...
            try (TransactionLog log = new TransactionLog()) {
                ...
                log.log(String.format("Retiro de $%.2f de cuenta origen. Saldo: $%.2f",
                        amount, this.balance));

                target.deposit(amount);
                log.log(String.format("Deposito de $%.2f en cuenta destino. Saldo: $%.2f",
